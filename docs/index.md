...
| <span id='パラレルノーツ'></span>**パラレルノーツ**<br><small>*Parallel Note*</small> | 同じ色・同じ方向のノーツが、横に2つ以上並んでいる配置。<br>通常のスイングでは取りこぼしてしまう為、<a href="#ヒットボックス">ヒットボックス</a>や方向判定の仕組みを応用した切り方が求められる。特殊な配置。ロロッペノーツとも。<br><img src="images/parallel.jpg" width="150"> |
